About r-distributional-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-distributional-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-distributional-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-distributional
# for installing globally
pixi global install r-distributional
```
...
It is possible to list all of the versions of `r-distributional` available on your platform:
...
```
pixi search r-distributional --channel conda-forge
```
